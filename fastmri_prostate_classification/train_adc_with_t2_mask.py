...
from utils.custom_data_adc_with_t2w_mask import load_data
...
def train_network(config):
    ...
    for e in range(config['training']['max_epochs']):  
        ...
        saver[e]['val_recall'] = recall_val
        saver[e]['val_acc'] = acc_val
        saver[e]['val_con_matrix'] = conf_matrix_val
        ...
        saver[e]['train_recall'] = recall_train
        saver[e]['train_acc'] = acc_train
        saver[e]['train_con_matrix'] = conf_matrix_train
...
def get_parser():
    ...
    parser.add_argument('--concat_t2w', type=str2bool, required=True, help='Set to True or False to specify whether to concatenate T2W as an additional channel.')
    return parser
